...
<h1 class="text-3xl font-bold mb-6">Active Challenge</h1>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow">
    {#if $activeChallenges}
        {#each $activeChallenges as activeChallenge, index}
            <Card class>
                ...
                <CardContent>
                    <p class="mb-4">
                        Progress: {activeChallenge.currentDay - 1} days of {activeChallenge.totalDays} completed
                    </p>
                </CardContent>
                <CardFooter>
                    <Button variant="default" onclick={() => startChallenge(activeChallenge)}>Continue Challenge</Button>
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>{activeChallenge.name}</DialogTitle>
                                <DialogDescription
                                    >
                                    <p>Delete {activeChallenge.name} from your active Challenges?</p>
                                    <p>Attention, all your progress on this challenge will be deleted too!</p>
                                </DialogDescription>
                            </DialogHeader>
                            <DialogFooter>
                                <Button
                                    onclick={() => deleteChallenge(activeChallenge)}
                                >
    ...
    {:else}
        <Card>
            <CardHeader>
                Keine Aktive Challenge?? Na dann ran an den Speck!
                Such dir was schönes aus oder werde kreativ.
            ...
            <CardContent>
                <p>
                    You don't have any active challenges at the moment. Create a
                    new one or search for existing challenges to get started!
                </p>
            </CardContent>
            <CardHeader>
            ...
            <CardContent>
                <p>
                    Design your own custom challenge tailored to your fitness
                    goals.
                </p>
            </CardContent>
            <CardFooter>
            ...
            <CardFooter>
                <Button variant="default" onclick={searchExistingChallenges}>
